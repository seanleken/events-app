    ...
    return (
        <div className="form-container">
            <form className="signup-form" action="" onSubmit={onSubmit}>
                ...
                <input type="email" name="email" id="email" value={fields.email} onChange={onChanged("email")}/>
                <label htmlFor="password">Password</label>
                <input type="password" name="password" id="password" value={fields.password} onChange={onChanged("password")}/>
                <label htmlFor="repeatPassword">Repeat Password</label>
                <input type="password" name="repeatPassword" id="repeatPassword" onChange={onChanged("repeatPassword")}/>
